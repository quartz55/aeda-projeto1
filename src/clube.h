 ...
 * @file   clube.h
 * 
 * @brief Ficheiro respons�vel pela classe Clube
 * 
 */
...
/**
 * Operadores da tabela de dispers�o.
 */
struct Hash{
...
class Clube{
  ...
  SociosHash socios_em_atraso; /**< Socios com quotas em atraso guardados numa tabela de dispers�o */
